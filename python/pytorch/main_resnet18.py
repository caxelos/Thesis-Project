...
def main():
    ...
    model = module.ResNet6(ff1_out=args.ff1_out,ff2_out=args.ff2_out, blocks_sizes=args.block_sizes,deepths=args.deepths,gate_kernel=args.gate_kernel)#blocks_sizes=[64,128,256,512], deepths=[2,2,2,2])
