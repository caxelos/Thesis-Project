...
resnet8_preact_basicBlock = pd.read_csv('resnet8_preact_basic/test_mean.txt').values
zhang = pd.read_csv('zhang_basic_60_epochs/test_mean.txt').values
resnet6_basic = pd.read_csv('resnet6_basic/test_mean.txt').values
resnet8_preact_bottleneckBlock = pd.read_csv('resnet8_preact_bottleneck/test_mean.txt').values
